...
private:
    ...
    int rows, cols;
    int mrow, mcol, direc, exitR, exitC;
    char grid[40][40];
    bool path,obj;                    //turned on shows where the mover has been turned off the grid DOESNT change
    hasBeen list[500];
    int listA = 0;


    static char DirecR(int d) ;            //Whatever direction is enter will be returned as the char
